...
Minecraft.allBlocks = [];
Minecraft.selectedWidth = 1200; // default map width
Minecraft.mapHeight = 1000; // default map height

Minecraft.start = function() { // starting game
    var letsPlay = new Minecraft.map;
    letsPlay.generateMap(Minecraft.selectedWidth, Minecraft.mapHeight);
